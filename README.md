...
10 种测试数据 × 3 个版本 + gzip -9 基准。**数值越低越好**（压缩后 / 原始大小）。

| 测试数据 | 大小 | v0 Order-0 | v1 Order-1 | v2 PPM-3 | gzip -9 |
|---------|-----:|:---:|:---:|:---:|:---:|
| English prose (5.4KB) | 5,390 | 62.3% | 42.6% | **11.1%** | 6.4% |
| Short English (122B) | 122 | **86.1%** | 95.9% | 91.0% | 113.1% |
| JSON lines (3.0KB) | 2,649 | 59.7% | 53.4% | **25.3%** | 18.4% |
| Chinese text (8.7KB) | 4,080 | 72.4% | 60.6% | **20.0%** | 5.9% |
| TypeScript code (3.8KB) | 4,060 | 58.7% | 52.0% | **17.1%** | 7.4% |
| HTML markup (2.2KB) | 3,173 | 61.6% | 51.5% | **21.2%** | 13.4% |
| CSV data (5.6KB) | 3,957 | 65.9% | 63.8% | **38.9%** | 31.7% |
| Log file (5.5KB) | 6,565 | 66.6% | 58.0% | **26.2%** | 15.6% |
| Multilingual (2.8KB) | 2,746 | 74.5% | 60.8% | **23.1%** | 11.6% |
| Random bytes (4KB) | 4,096 | 101.1% | 100.1% | **99.8%** | 101.0% |
...
| **v2** | PPM Order-3 Blended | **C++ (N-API)** | 融合 4 层上下文（order 0-3），哈希表存储高阶上下文 |
...
- 但 LexiFold v2 在 **短文本** 上始终优于 gzip（91.0% vs 113.1%）——预测式压缩无头部开销。
- **关键优势**：LexiFold 的 PPM 后端可随时替换为神经网络，而 gzip 无法演进。
